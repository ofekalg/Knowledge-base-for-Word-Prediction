...
public class JFS_sum {
    ...
    public static class CombinerClassJFS_sum extends Reducer<Text, LongWritable, Text, LongWritable> {
        @Override
    ...
    public static void main(String[] args) throws Exception {
        ...
        job1.setCombinerClass(JFS_sum.CombinerClassJFS_sum.class);
        ...
        job2.setCombinerClass(JFS_sum.CombinerClassJFS_sum.class);
